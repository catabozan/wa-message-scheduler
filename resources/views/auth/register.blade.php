                ...
                <div class="mt-8">
                    ...
                    <form action="{{ route('register') }}" method="POST" autoComplete="on">
                        ...
                        <div class="flex flex-col mb-2">
                            <x-icon-input type="text" name="name" id="name" placeholder="Your name" required
                                :value="old('name')">
                        ...
                        {{-- Email input --}}
                        <div class="flex flex-col mb-2">
                            <x-icon-input type="email" name="email" id="email" placeholder="Your email" required
                                :value="old('email')">
                                <svg width="15" height="15" fill="currentColor" viewBox="0 0 1792 1792"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                        ...
                        {{-- Password input --}}
                        <div class="flex flex-col mb-2">
                            <x-icon-input type="password" name="password" id="password" placeholder="Your password"
                                required>
                                <svg width="15" height="15" fill="currentColor" viewBox="0 0 1792 1792"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                        ...
                        <div class="flex flex-col mb-12">
                            <x-icon-input type="password" name="password_confirmation" id="password_confirmation"
